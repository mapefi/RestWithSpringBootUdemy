...
public class DozerConverterBookTest {
    ...
    public void parseEntityToVOTest() {
        ...
        Assert.assertNotNull(output.getLaunchDate());
        Assert.assertNotNull(output.getPrice());
    ...
    public void parseEntityListToVOListTest() {
        ...
        Assert.assertNotNull(outputZero.getLaunchDate());
        Assert.assertNotNull(outputZero.getPrice());
        ...
        Assert.assertNotNull(outputSeven.getLaunchDate());
        Assert.assertNotNull(outputSeven.getPrice());
        ...
        Assert.assertNotNull(outputTwelve.getLaunchDate());
        Assert.assertNotNull(outputTwelve.getPrice());
